				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>Build yourself a comfortable gym at home with us</h1>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Our Team</h2>
					<p>Our team of experts will help you with the process of making your perfect home gym</p>
				</div>
			</div>
			<div class="row">
	...
	<div id="fh5co-pricing">
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Pricing</h2>
					<p>We generally don't say a fixed price. It depends only on your needs. You choose any equipment you want and we will make it happen at a resonable price</p>
				</div>
			</div>
